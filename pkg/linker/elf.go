...
const (
	...
	R_X86_64_PLT32       = 4  // PC-relative 32-bit (PLT) - matches system elf.h
	R_X86_64_32          = 10 // Direct 32-bit zero extended - matches system elf.h
	R_X86_64_32S         = 11 // Direct 32-bit sign extended - matches system elf.h
	R_X86_64_16          = 5  // Direct 16-bit
	R_X86_64_PC16        = 6  // PC-relative 16-bit
	R_X86_64_8           = 7  // Direct 8-bit
	R_X86_64_PC8         = 8  // PC-relative 8-bit
	R_X86_64_GOT32       = 3  // 32-bit GOT entry (matches system elf.h)
